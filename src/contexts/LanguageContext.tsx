...
const translations: Record<string, Record<Lang, string>> = {
  ...
  profileDataTitle: { pt: 'Dados do perfil:', en: 'Profile data:', es: 'Datos del perfil:' },
  profileDataNotLoaded: { pt: 'Dados do perfil não carregados.', en: 'Profile data not loaded.', es: 'Datos del perfil no cargados.' },
  ...
  viewProfileData: { pt: 'Ver Meus Dados', en: 'View My Data', es: 'Ver Mis Datos' },
  scannerApiKeyInfo: {
  ...
  aiStep4: { pt: 'Identificando o local da compra', en: 'Identifying purchase location', es: 'Identificando el lugar de compra' },
  aiStep5: { pt: 'Extraindo itens comprados, quantidades e preços', en: 'Extracting items, quantities and prices', es: 'Extrayendo ítems, cantidades y precios' },
  aiStep6: { pt: 'Localizando data de compra', en: 'Locating purchase date', es: 'Localizando fecha de compra' },
  ...
  shoppingTip: { pt: 'Dica: Ao invés de adicionar itens um a um, prefira usar somente o escâner de cupom logo após as compras. É mais rápido e automático.', en: 'Tip: Instead of adding items one by one, prefer to use only the receipt scanner right after shopping. It is faster and automatic.', es: 'Tip: En lugar de añadir ítems uno a uno, prefiere usar solo el escáner de cupones tras las compras. Es más rápido y automático.' },
  ...
  manualEntry: { pt: 'Entrada Manual', en: 'Manual Entry', es: 'Manual Entry' },
  ...
  supermarket: { pt: 'Supermercado', en: 'Supermarket', es: 'Supermercado' },
