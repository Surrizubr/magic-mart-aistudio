...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // Stock Page
  stockTitle: { pt: 'Estoque', en: 'Stock', es: 'Inventario' },
  stockItemsCount: { pt: 'produtos', en: 'products', es: 'productos' },
  searchStockPlaceholder: { pt: 'Buscar por produto ou categoria...', en: 'Search for product or category...', es: 'Buscar por producto o categoría...' },
  ...
  swipeHintStock: { pt: '← Deslize para excluir · Deslize para adicionar ao lembrete →', en: '← Swipe to delete · Swipe to add to reminder →', es: '← Desliza para eliminar · Desliza para añadir recordatorio →' },
  edit: { pt: 'Editar', en: 'Edit', es: 'Editar' },
  bought: { pt: 'comprado', en: 'bought', es: 'comprado' },
  ...
  daysPerCycle: { pt: 'd por ciclo', en: 'd per cycle', es: 'd por ciclo' },
  zeroQty: { pt: 'Zerar', en: 'Zero', es: 'Poner a cero' },
  productAddedToStock: { pt: 'Produto adicionado ao estoque!', en: 'Product added to stock!', es: '¡Producto añadido al inventario!' },
  manualEntry: { pt: 'Entrada Manual', en: 'Manual Entry', es: 'Entrada Manual' },
  // Shopping Page
  goShoppingTitle: { pt: 'Fazer Mercado', en: 'Go Shopping', es: 'Ir al Mercado' },
  chooseShoppingMode: { pt: 'Escolha como registrar suas compras', en: 'Choose how to register your purchases', es: 'Elige cómo registrar tus compras' },
  withList: { pt: 'Com Lista', en: 'With List', es: 'Con Lista' },
  openActiveLists: { pt: 'Abrir listas ativas para fazer compras', en: 'Open active lists for shopping', es: 'Abrir listas activas para comprar' },
  register: { pt: 'Registrar', en: 'Register', es: 'Registrar' },
  useCameraToRecognize: { pt: 'Usar câmera para reconhecer produtos', en: 'Use camera to recognize products', es: 'Usar cámara para reconocer productos' },
  byCategory: { pt: 'Por Categoria', en: 'By Category', es: 'Por Categoría' },
  searchByCategory: { pt: 'Buscar produto por categoria', en: 'Search product by category', es: 'Buscar producto por categoría' },
  howItWorks: { pt: 'Como funciona?', en: 'How it works?', es: '¿Cómo funciona?' },
  shoppingStep1: { pt: 'Adicione os itens comprados um a um;', en: 'Add purchased items one by one;', es: 'Añade los artículos comprados uno a uno;' },
  shoppingStep2List: { pt: 'Insira os itens usando uma lista ativa, ou por reconhecimento de imagem, ou manualmente;', en: 'Insert items using an active list, or by image recognition, or manually;', es: 'Inserta los artículos usando una lista activa, o por reconocimiento de imagen, o manualmente;' },
  shoppingStep2Register: { pt: 'Tire a foto do rótulo do produto que quer adicionar;', en: 'Take a photo of the product label you want to add;', es: 'Toma una foto de la etiqueta del producto que quieres añadir;' },
  shoppingStep2Category: { pt: 'Adicione produtos manualmente a partir da lista de categorias;', en: 'Manually add products from the category list;', es: 'Añade productos manualmente desde la lista de categorías;' },
  shoppingStep3: { pt: 'Ao encerrar as compras, os itens vão direto para o estoque;', en: 'When shopping ends, items go straight to stock;', es: 'Al terminar las compras, los artículos van directo al inventario;' },
  shoppingStep4: { pt: 'Após concluir sua compra, vá em histórico e escaneie o cupom para atualizar os preços.', en: 'After completing your purchase, go to history and scan the receipt to update prices.', es: 'Después de completar tu compra, ve al historial y escanea el recibo para actualizar los precios.' },
  tipLabel: { pt: 'Dica:', en: 'Tip:', es: 'Consejo:' },
  shoppingTip: { pt: 'Ao invés de adicionar itens um a um, prefira usar somente o escâner de cupom logo após as compras. É mais rápido e automático.', en: 'Instead of adding items one by one, prefer to use only the receipt scanner right after shopping. It is faster and automatic.', es: 'En lugar de añadir artículos uno a uno, prefiere usar solo el escáner de recibos justo después de comprar. Es más rápido y automático.' },
  locationObtained: { pt: 'Localização obtida!', en: 'Location obtained!', es: '¡Localización obtenida!' },
  coordsSaved: { pt: 'Coordenadas salvas.', en: 'Coordinates saved.', es: 'Coordenadas guardadas.' },
  coordsSavedNoNet: { pt: 'Coordenadas salvas (sem acesso à internet para nome da rua).', en: 'Coordinates saved (no internet access for street name).', es: 'Coordenadas guardadas (sin acceso a internet para el nombre de la calle).' },
  locationError: { pt: 'Não foi possível obter localização', en: 'Unable to get location', es: 'No se pudo obtener la ubicación' },
  informShoppingLocation: { pt: 'Informe o local de compras', en: 'Enter shopping location', es: 'Ingresa el lugar de compra' },
  noItemAdded: { pt: 'Nenhum item adicionado', en: 'No item added', es: 'Ningún artículo añadido' },
  itemsAddedToStock: { pt: 'itens adicionados ao estoque', en: 'items added to stock', es: 'artículos añadidos al inventario' },
  cameraAccessError: { pt: 'Não foi possível acessar a câmera:', en: 'Unable to access camera:', es: 'No se pudo acceder a la cámara:' },
  ...
  marketName: { pt: 'Nome do mercado', en: 'Market name', es: 'Nombre del mercado' },
  marketNamePlaceholder: { pt: 'Ex: Supermercado Extra', en: 'Ex: Extra Supermarket', es: 'Ej: Supermercado Extra' },
  or: { pt: 'ou', en: 'or', es: 'o' },
  getting: { pt: 'Obtendo...', en: 'Getting...', es: 'Obteniendo...' },
  useLocation: { pt: 'Usar localização', en: 'Use location', es: 'Usar ubicación' },
  continueBtn: { pt: 'Continuar', en: 'Continue', es: 'Continuar' },
  pointAtProduct: { pt: 'Aponte para o produto', en: 'Point at product', es: 'Apunta al producto' },
  analyzingProduct: { pt: 'Analisando Produto', en: 'Analyzing Product', es: 'Analizando Producto' },
  aiIdentifyingItem: { pt: 'A Inteligência Artificial está identificando o item...', en: 'AI is identifying the item...', es: 'La IA está identificando el artículo...' },
  secondsWarning: { pt: 'Isso pode levar alguns segundos', en: 'This may take a few seconds', es: 'Esto puede llevar unos segundos' },
  reject: { pt: 'Recusar', en: 'Reject', es: 'Rechazar' },
  accept: { pt: 'Aceitar', en: 'Accept', es: 'Aceptar' },
  shoppingInProgress: { pt: 'Compras em andamento', en: 'Shopping in progress', es: 'Compras en progreso' },
  ...
  productRecognized: { pt: 'Produto reconhecido:', en: 'Product recognized:', es: 'Producto reconocido:' },
  recognizing: { pt: 'Reconhecendo...', en: 'Recognizing...', es: 'Reconociendo...' },
  newItem: { pt: 'Novo item', en: 'New item', es: 'Nuevo artículo' },
  productNamePlaceholder: { pt: 'Nome do produto', en: 'Product name', es: 'Nombre del producto' },
  // Reports Page
  reportsTitle: { pt: 'Relatórios', en: 'Reports', es: 'Informes' },
  ...
  monthlyAverage: { pt: 'Média/Mês', en: 'Monthly Average', es: 'Promedio Mensual' },
  ...
  monthlyEvolution: { pt: 'Evolução Mensal', en: 'Monthly Evolution', es: 'Evolución Mensual' },
  lastMonths: { pt: 'Últimos', en: 'Last', es: 'Últimos' },
  spending: { pt: 'Gasto', en: 'Spending', es: 'Gasto' },
  noSpendingData: { pt: 'Sem dados de compras para exibir evolução mensal.', en: 'No shopping data to display monthly evolution.', es: 'Sin datos de compras para mostrar la evolución mensual.' },
  spendingByCategory: { pt: 'Gastos por Categoria', en: 'Spending by Category', es: 'Gastos por Categoría' },
  noCategoryData: { pt: 'Sem dados de categorias para exibir.', en: 'No category data to display.', es: 'Sin datos de categorías para mostrar.' },
  mostBought: { pt: 'Mais Comprados', en: 'Most Bought', es: 'Más Comprados' },
  ...
  openInGoogleMaps: { pt: 'Abrir no Google Maps', en: 'Open in Google Maps', es: 'Abrir en Google Maps' },
  noVisitRegistered: { pt: 'Nenhuma visita registrada.', en: 'No visit registered.', es: 'Ninguna visita registrada.' },
  // Savings Page
  savingsTitle: { pt: 'Dias Mais Baratos', en: 'Cheapest Days', es: 'Días Más Baratos' },
  savingsSubtitle: { pt: 'Análise de preços por dia', en: 'Price analysis by day', es: 'Análisis de precios por día' },
  potentialSavings: { pt: 'Economia Potencial', en: 'Potential Savings', es: 'Ahorro Potencial' },
  moreDataNeeded: { pt: 'Necessário mais dados históricos', en: 'More historical data needed', es: 'Se necesitan más datos históricos' },
  savingsDisclaimer: { pt: 'Valor estimado. A economia real depende de disponibilidade, localização e variações de preço entre lojas.', en: 'Estimated value. Real savings depend on availability, location and price variations between stores.', es: 'Valor estimado. El ahorro real depende de la disponibilidad, ubicación y variaciones de precio entre tiendas.' },
  ...
  weekDaysText: { pt: 'Dias da Semana', en: 'Days of the Week', es: 'Días de la Semana' },
  weekHint: { pt: 'Últimas 4 semanas · Toque para ver os locais', en: 'Last 4 weeks · Tap to see locations', es: 'Últimas 4 semanas · Toca para ver los lugares' },
  monthDaysText: { pt: 'Dias do Mês', en: 'Days of the Month', es: 'Días del Mes' },
  monthHint: { pt: 'Últimos 3 meses · Toque para ver os locais', en: 'Last 3 months · Tap to see locations', es: 'Últimos 3 meses · Toca para ver los lugares' },
  day: { pt: 'Dia', en: 'Day', es: 'Día' },
  locationsVisited: { pt: 'local(is) visitado(s)', en: 'location(s) visited', es: 'lugar(es) visitado(s)' },
  item: { pt: 'item', en: 'item', es: 'artículo' },
  // Share Page
  shareTitle: { pt: 'Compartilhar', en: 'Share', es: 'Compartir' },
  shareSubtitle: { pt: 'Envie listas via WhatsApp', en: 'Send lists via WhatsApp', es: 'Enviar listas vía WhatsApp' },
  emptyList: { pt: '(lista vazia)', en: '(empty list)', es: '(lista vacía)' },
  estimatedTotalLabel: { pt: 'Total estimado:', en: 'Estimated total:', es: 'Total estimado:' },
  sentViaMagicmart: { pt: 'Enviado via Magicmart AI 🌿', en: 'Sent via Magicmart AI 🌿', es: 'Enviado vía Magicmart AI 🌿' },
  selectAtLeastOneList: { pt: 'Selecione pelo menos uma lista', en: 'Select at least one list', es: 'Selecciona al menos una lista' },
  noActiveListsToShare: { pt: 'Nenhuma lista ativa para compartilhar.', en: 'No active lists to share.', es: 'Ninguna lista activa para compartir.' },
  ...
  sendViaWhatsApp: { pt: 'Enviar via WhatsApp', en: 'Send via WhatsApp', es: 'Enviar vía WhatsApp' },
  // Lists Page
  listsTitle: { pt: 'Listas de Compras', en: 'Lists', es: 'Listas' },
  listsSubtitle: { pt: 'Organize suas compras', en: 'Organize your shopping', es: 'Organiza sus compras' },
  active: { pt: 'Ativas', en: 'Active', es: 'Activas' },
  completed: { pt: 'Concluídas', en: 'Completed', es: 'Completadas' },
  archived: { pt: 'Arquivo', en: 'Archived', es: 'Archivo' },
  swipeHintLists: { pt: '← Deslize para excluir · Deslize para arquivar →', en: '← Swipe to delete · Swipe to archive →', es: '← Desliza para eliminar · Desliza para archivar →' },
  listNamePlaceholder: { pt: 'Nome da lista...', en: 'List name...', es: 'Nombre de la lista...' },
  createList: { pt: 'Criar Lista', en: 'Create List', es: 'Crear Lista' },
  noListFound: { pt: 'Nenhuma lista encontrada', en: 'No list found', es: 'No se encontró ninguna lista' },
  shoppingEmoji: { pt: '🛒 Em compras · ', en: '🛒 Shopping · ', es: '🛒 Comprando · ' },
  listRestored: { pt: 'Lista restaurada.', en: 'List restored.', es: 'Lista restaurada.' },
  // List Detail Page
  itemRemoved: { pt: 'Item removido.', en: 'Item removed.', es: 'Artículo eliminado.' },
  selectItemsToProcess: { pt: 'Selecione os itens comprados e clique em "Encerrar Compras".', en: 'Select the purchased items and click "End Shopping".', es: 'Selecciona los artículos comprados y haz clic en "Terminar Compras".' },
  selectAtLeastOneItem: { pt: 'Selecione pelo menos um item antes de encerrar.', en: 'Select at least one item before ending.', es: 'Selecciona al menos un artículo antes de terminar.' },
  shoppingEnded: { pt: 'Compras encerradas! Lista concluída.', en: 'Shopping ended! List completed.', es: '¡Compras terminadas! Lista completada.' },
  itemsAddedToStockDetail: { pt: 'item(ns) adicionado(s) ao estoque. item(ns) permanecem na lista.', en: 'item(s) added to stock. item(s) remain on the list.', es: 'artículo(s) añadido(s) al inventario. artículo(s) permanecen en la lista.' },
  selectedCount: { pt: 'selecionados', en: 'selected', es: 'seleccionados' },
  addItemBtn: { pt: 'Adicionar Item', en: 'Add Item', es: 'Añadir Artículo' },
  emptyListMessage: { pt: 'Lista vazia. Adicione itens acima.', en: 'Empty list. Add items above.', es: 'Lista vacía. Añade artículos arriba.' },
  concludeList: { pt: 'Concluir Lista', en: 'Complete List', es: 'Completar Lista' },
  transferWarning: { pt: '⚠️ Ao encerrar, os itens selecionados serão transferidos para o estoque.', en: '⚠️ When ending, the selected items will be transferred to stock.', es: '⚠️ Al terminar, los artículos seleccionados serán transferidos al inventario.' },
  shoppingLocation: { pt: 'Local de Compras', en: 'Shopping Location', es: 'Lugar de Compra' },
  informWhereYouShopped: { pt: 'Informe onde você fez as compras:', en: 'Enter where you shopped:', es: 'Ingresa donde hiciste las compras:' },
  ...
  confirm: { pt: 'Confirmar', en: 'Confirm', es: 'Confirmar' },
  // Login Page
  popupBlocked: { pt: 'O bloqueador de popups impediu o login. Por favor, autorize popups.', en: 'Popup blocker prevented login. Please authorize popups.', es: 'El bloqueador de ventanas emergentes impidió el inicio de sesión. Por favor, autoriza las ventanas emergentes.' },
  loginSuccess: { pt: 'Login realizado com sucesso!', en: 'Login successful!', es: '¡Inicio de sesión exitoso!' },
  loginError: { pt: 'Erro ao iniciar login', en: 'Error starting login', es: 'Error al iniciar sesión' },
  agreeToTerms: { pt: 'Ao continuar, você concorda com nossos', en: 'By continuing, you agree to our', es: 'Al continuar, aceptas nuestros' },
  ...
  // Categories
  laticinios: { pt: 'Laticínios', en: 'Dairy', es: 'Lácteos' },
  graos: { pt: 'Grãos', en: 'Grains', es: 'Granos' },
  ...
  verduras: { pt: 'Verduras', en: 'Vegetables', es: 'Verduras' },
  legumes: { pt: 'Legumes', en: 'Legumes', es: 'Legumbres' },
  geral: { pt: 'Geral', en: 'General', es: 'General' },
  cheapestDaysTitle: { pt: 'Dias Mais Baratos', en: 'Cheapest Days', es: 'Días Más Baratos' },
  priceAnalysisByDay: { pt: 'Análise de preços por dia', en: 'Price analysis by day', es: 'Análisis de precios por día' },
  moreDataWarning: { pt: 'Necessário mais dados históricos', en: 'More historical data needed', es: 'Se necesitan más datos históricos' },
  legendVeryCheap: { pt: 'Muito barato', en: 'Very cheap', es: 'Muy barato' },
  legendCheap: { pt: 'Barato', en: 'Cheap', es: 'Barato' },
  legendNormal: { pt: 'Normal', en: 'Normal', es: 'Normal' },
  legendExpensive: { pt: 'Caro', en: 'Expensive', es: 'Caro' },
  legendVeryExpensive: { pt: 'Muito caro', en: 'Very expensive', es: 'Muy caro' },
  weekDaysHeatmap: { pt: 'Dias da Semana', en: 'Days of the Week', es: 'Días de la Semana' },
  lastWeeksCount: { pt: 'Últimas 4 semanas', en: 'Last 4 weeks', es: 'Últimas 4 semanas' },
  tapToSeeStores: { pt: 'Toque para ver os locais', en: 'Tap to see stores', es: 'Toca para ver los lugares' },
  monthDaysHeatmap: { pt: 'Dias do Mês', en: 'Days of the Month', es: 'Días del Mes' },
  lastMonthsCount: { pt: 'Últimos 3 meses', en: 'Last 3 months', es: 'Últimos 3 meses' },
  locationVisited: { pt: 'local visitado', en: 'location visited', es: 'lugar visitado' },
  locationsVisited: { pt: 'locais visitados', en: 'locations visited', es: 'lugares visitados' },
  listDeletedToast: { pt: 'Lista excluída.', en: 'List deleted.', es: 'Lista eliminada.' },
  listRestoredToast: { pt: 'Lista restaurada.', en: 'List restored.', es: 'Lista restaurada.' },
  listArchivedToast: { pt: 'Lista arquivada.', en: 'List archived.', es: 'Lista archivada.' },
  organizeShopping: { pt: 'Organize suas compras', en: 'Organize your shopping', es: 'Organiza tus compras' },
  swipeHint: { pt: '← Deslize para excluir · Deslize para arquivar →', en: '← Swipe to delete · Swipe to archive →', es: '← Desliza para eliminar · Desliza para archivar →' },
  createListBtn: { pt: 'Criar Lista', en: 'Create List', es: 'Crear Lista' },
  noListsFound: { pt: 'Nenhuma lista encontrada', en: 'No lists found', es: 'No se encontraron listas' },
  inShopping: { pt: 'Em compras', en: 'In shopping', es: 'En compras' },
  itemRemovedToast: { pt: 'Item removido.', en: 'Item removed.', es: 'Artículo eliminado.' },
  selectItemsInfo: { pt: 'Selecione os itens comprados e clique em "Encerrar Compras".', en: 'Select the purchased items and click "End Shopping".', es: 'Selecciona los artículos comprados y haz clic en "Terminar Compras".' },
  selectAtLeastOneWarning: { pt: 'Selecione pelo menos um item antes de encerrar.', en: 'Select at least one item before ending.', es: 'Selecciona al menos un artículo antes de terminar.' },
  locationObtainedToast: { pt: 'Localização obtida!', en: 'Location obtained!', es: '¡Localización obtenida!' },
  coordsSavedToast: { pt: 'Coordenadas salvas.', en: 'Coordinates saved.', es: 'Coordenadas guardadas.' },
  locationErrorToast: { pt: 'Não foi possível obter localização.', en: 'Unable to get location.', es: 'No se pudo obtener la ubicación.' },
  enterStoreLocationError: { pt: 'Informe o local de compras.', en: 'Enter the shopping location.', es: 'Ingresa el lugar de compra.' },
  shoppingFinishedSuccess: { pt: 'Compras encerradas! Lista concluída.', en: 'Shopping finished! List completed.', es: '¡Compras terminadas! Lista completada.' },
  itemsAddedToStock: { pt: 'item(ns) adicionado(s) ao estoque.', en: 'item(s) added to stock.', es: 'artículo(s) añadido(s) al inventario.' },
  itemsRemainInList: { pt: 'item(ns) permanecem na lista.', en: 'item(s) remain on the list.', es: 'artículo(s) permanecen en la lista.' },
  selected: { pt: 'selecionados', en: 'selected', es: 'seleccionados' },
  emptyListMsg: { pt: 'Lista vazia. Adicione itens acima.', en: 'Empty list. Add items above.', es: 'Lista vacía. Añada artículos arriba.' },
  finishListBtn: { pt: 'Concluir Lista', en: 'Finish List', es: 'Concluir Lista' },
  transferToStockHint: { pt: '⚠️ Ao encerrar, os itens selecionados serão transferidos para o estoque.', en: '⚠️ When finished, selected items will be moved to stock.', es: '⚠️ Al terminar, los artículos seleccionados se moverán al stock.' },
  endShoppingBtn: { pt: 'Encerrar Compras', en: 'End Shopping', es: 'Terminar Compras' },
  shoppingLocationTitle: { pt: 'Local de Compras', en: 'Shopping Location', es: 'Lugar de Compra' },
  informLocationHint: { pt: 'Informe onde você fez as compras:', en: 'Tell us where you shopped:', es: 'Dinos dónde compraste:' },
  gettingAddress: { pt: 'Obtendo endereço...', en: 'Getting address...', es: 'Obteniendo dirección...' },
  useMyLocationBtn: { pt: 'Usar minha localização', en: 'Use my location', es: 'Usar mi ubicación' },
  popupBlockedError: { pt: 'O bloqueador de popups impediu o login. Por favor, autorize popups.', en: 'Popup blocker prevented login. Please authorize popups.', es: 'El bloqueador de popups impidió o login.' },
  loginSuccessToast: { pt: 'Login realizado com sucesso!', en: 'Login successful!', es: '¡Login exitoso!' },
  termsDisclaimer: { pt: 'Ao continuar, você concorda com nossos', en: 'By continuing, you agree to our', es: 'Al continuar, aceptas nuestros' },
  and: { pt: 'e', en: 'and', es: 'y' },
  totalEstimated: { pt: 'Total estimado', en: 'Total estimated', es: 'Total estimado' },
  sentViaApp: { pt: 'Enviado via Magicmart AI', en: 'Sent via Magicmart AI', es: 'Enviado vía Magicmart AI' },
  selectAtLeastOneListWarning: { pt: 'Selecione pelo menos uma lista', en: 'Select at least one list', es: 'Selecciona al menos una lista' },
  sendViaWhatsApp: { pt: 'Envie listas via WhatsApp', en: 'Send lists via WhatsApp', es: 'Envía listas vía WhatsApp' },
  noListsToShare: { pt: 'Nenhuma lista ativa para compartilhar.', en: 'No active lists to share.', es: 'Ninguna lista activa para compartir.' },
  selectListsToShareHint: { pt: 'Selecione as listas que deseja compartilhar', en: 'Select the lists you want to share', es: 'Selecciona las listas que deseas compartir' },
  sendViaWhatsAppBtn: { pt: 'Enviar via WhatsApp', en: 'Send via WhatsApp', es: 'Enviar vía WhatsApp' },
  processing: { pt: 'Processando...', en: 'Processing...', es: 'Procesando...' },
  months: { pt: 'meses', en: 'months', es: 'meses' },
  lastMonths: { pt: 'Últimos', en: 'Last', es: 'Últimos' },
};
