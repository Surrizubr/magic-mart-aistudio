...
const translations: Record<string, Record<Lang, string>> = {
  ...
  selectFromGallery: { pt: 'Selecionar da galeria', en: 'Select from gallery', es: 'Seleccionar de la galería' },
  ...
  testingConnection: { pt: 'testando conexão...', en: 'testing connection...', es: 'probando conexión...' },
  connectionSuccess: { pt: 'Conexão OK: ', en: 'Connection OK: ', es: 'Conexión OK: ' },
  iaUnexpectedResponse: { pt: 'Resposta inesperada: ', en: 'Unexpected response: ', es: 'Respuesta inesperada: ' },
  connectionError: { pt: 'Erro de conexão: ', en: 'Connection error: ', es: 'Error de conexión: ' },
  unknownError: { pt: 'Erro desconhecido', en: 'Unknown error', es: 'Error desconocido' },
  profileDataTitle: { pt: 'Dados do perfil:', en: 'Profile data:', es: 'Datos del perfil:' },
  profileDataNotLoaded: { pt: 'Dados não carregados.', en: 'Data not loaded.', es: 'Datos no cargados.' },
  ...
  clearKey: { pt: 'Limpar Chave', en: 'Clear Key', es: 'Limpiar Clave' },
  ...
  viewProfileData: { pt: 'Ver Perfil', en: 'View Profile', es: 'Ver Perfil' },
  diagnosticResult: { pt: 'Resultado do Diagnóstico', en: 'Diagnostic Result', es: 'Resultado del Diagnóstico' },
  devModeWarning: { pt: 'Atenção: Estas ferramentas são para uso técnico.', en: 'Warning: These tools are for technical use.', es: 'Atención: Estas herramientas son para uso técnico.' },
