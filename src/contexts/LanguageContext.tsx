...
const translations: Record<string, Record<Lang, string>> = {
  ...
  itemsAddedRemaining: { pt: 'itens adicionados ao estoque. Itens permanecem na lista.', en: 'items added to stock. Items remain on list.', es: 'ítems añadidos al stock. Ítems permanecen en la lista.' },
